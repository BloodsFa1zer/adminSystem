...
type ImageHandlersInterface interface {
	...
	ImagePOST(c echo.Context) error
	ImagesGET(c echo.Context) error
	ImageGetByID(c echo.Context) error
	ImagePUT(c echo.Context) error
}
